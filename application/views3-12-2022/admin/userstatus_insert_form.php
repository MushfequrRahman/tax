            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">User Status Insert</h3>
					<div class="row">
                ...
                <!-- /.box-header -->
                <div class="box-body ">
				 <form role="form" autocomplete="off" action="<?php echo base_url();?>Dashboard/userstatus_insert" method="post" enctype="multipart/form-data">
                 
                
                
                <div class="form-group">
					<label>User Status<em>*</em></label>
					<input type="text" class="form-control" name="userstatus" placeholder="Enter User Status">
