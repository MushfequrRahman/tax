            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/factory_list_up/<?php echo $bn=$row['factoryid'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
