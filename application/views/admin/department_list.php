            ...
            <div class="col-md-12">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">DepartmentInfo</h3>
					<div class="row">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <thead style="background:#91b9e6;">
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;"><?php echo $row['deptid'];?></td>
                  ...
                  <td style="vertical-align:middle;"><a href="<?php echo base_url();?>Dashboard/department_list_up/<?php echo $bn=$row['deptid'];?>"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
